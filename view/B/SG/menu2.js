            ...
            <div class="container">\
                <nav class="nav-main mega-menu">\
                    <ul class="nav nav-pills nav-main" id="mainMenu">\
                        <!-- Showroom Dropdown (Moved Left) -->\
                       <li class="dropdown">\
    <a class="dropdown-toggle" href="#">Showroom <i class="icon icon-angle-down"></i></a>\
    <ul class="dropdown-menu">\
        <li><a href="/B/' + countryPrefix + '/showroom/bedroom.html" target="_blank"><i class="icon icon-bed"></i> Bedroom</a></li>\
        <li><a href="/B/' + countryPrefix + '/showroom/kitchen.html" target="_blank"><i class="icon icon-cutlery"></i> Kitchen</a></li>\
        <li><a href="/B/' + countryPrefix + '/showroom/livingroom.html" target="_blank"><i class="icon icon-sofa"></i> Living Room</a></li>\
        <li><a href="/B/' + countryPrefix + '/showroom/toilet.html" target="_blank"><i class="icon icon-bath"></i> Toilet</a></li>\
    </ul>\
</li>\
